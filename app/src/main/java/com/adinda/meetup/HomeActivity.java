...
import com.adinda.meetup.fragment.NotificationFragment;
...
//        fragment = new ChatFragment();
        ...
        navigationView.setNavigationItemSelectedListener(
                ...
                if (id == R.id.nav_profile) {
                    fragment = new ProfileFragment();
                }elseif (id == R.id.nav_group){
                    fragment = new GroupFragment();
                }elseif (id == R.id.nav_event){
                    fragment = new EventFragment();
                }elseif (id == R.id.nav_notification) {
                    fragment = new NotificationFragment();
                }
//                elseif (id == R.id.nav_explore) {
//                    fragment = new ExploreFragment();
//                }elseif (id == R.id.nav_chat) {
//                    fragment = new ChatFragment();
//                }elseif (id == R.id.nav_newgroup) {
//                    fragment = new NewGroupFragment ();
//                }elseif (id == R.id.nav_newevent) {
